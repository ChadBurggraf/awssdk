...
namespace Amazon.ElasticLoadBalancing.Model
{
    ...
    {
        private DescribeInstanceHealthResult describeInstanceHealthResultField;
        ...
        /// Returns the current state of the instances of the specified LoadBalancer.
        /// </summary>
        [XmlElementAttribute(ElementName = "DescribeInstanceHealthResult")]
        public DescribeInstanceHealthResult DescribeInstanceHealthResult
        {
            get { return this.describeInstanceHealthResultField; }
            set { this.describeInstanceHealthResultField = value; }
        }

        /// <summary>
        /// Checks if DescribeInstanceHealthResult property is set
        /// </summary>
        /// <returns>true if DescribeInstanceHealthResult property is set</returns>
