...
namespace Amazon.IdentityManagement.Model.Transform
{
     ...
     /// </summary>
    internal class AccessKeyMetadataUnmarshaller : IUnmarshaller<AccessKeyMetadata, UnmarshallerContext> 
    {
        public AccessKeyMetadata Unmarshall(UnmarshallerContext context) 
        {
