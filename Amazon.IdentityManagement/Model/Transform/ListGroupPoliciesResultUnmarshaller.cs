...
namespace Amazon.IdentityManagement.Model.Transform
{
     ...
     /// </summary>
    internal class ListGroupPoliciesResultUnmarshaller : IUnmarshaller<ListGroupPoliciesResult, UnmarshallerContext> 
    {
        public ListGroupPoliciesResult Unmarshall(UnmarshallerContext context) 
        {
