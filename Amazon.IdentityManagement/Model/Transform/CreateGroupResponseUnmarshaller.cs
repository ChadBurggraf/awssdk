...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class CreateGroupResponseUnmarshaller : IResponseUnmarshaller<CreateGroupResponse, UnmarshallerContext> {

        public CreateGroupResponse Unmarshall(UnmarshallerContext context) {
        ...
        private static CreateGroupResponseUnmarshaller instance;
