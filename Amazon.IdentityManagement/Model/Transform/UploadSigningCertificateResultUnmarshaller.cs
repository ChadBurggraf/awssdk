...
namespace Amazon.IdentityManagement.Model.Transform
{
     ...
     /// </summary>
    internal class UploadSigningCertificateResultUnmarshaller : IUnmarshaller<UploadSigningCertificateResult, UnmarshallerContext> 
    {
        public UploadSigningCertificateResult Unmarshall(UnmarshallerContext context) 
        {
