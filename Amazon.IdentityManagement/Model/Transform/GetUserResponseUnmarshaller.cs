...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class GetUserResponseUnmarshaller : IResponseUnmarshaller<GetUserResponse, UnmarshallerContext> {

        public GetUserResponse Unmarshall(UnmarshallerContext context) {
            ...
            while (context.Read())
            {
                if (context.IsStartElement)
                {
                    ...
                    {
                        response.GetUserResult = GetUserResultUnmarshaller.GetInstance().Unmarshall(context);
                        continue;
                    }
