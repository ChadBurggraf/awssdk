...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class UpdateGroupResponseUnmarshaller : IResponseUnmarshaller<UpdateGroupResponse, UnmarshallerContext> {

        public UpdateGroupResponse Unmarshall(UnmarshallerContext context) {
        ...
        private static UpdateGroupResponseUnmarshaller instance;

        public static UpdateGroupResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new UpdateGroupResponseUnmarshaller();
            }
            return instance;
        }
    }
