...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class DeleteAccessKeyResponseUnmarshaller : IResponseUnmarshaller<DeleteAccessKeyResponse, UnmarshallerContext> {

        public DeleteAccessKeyResponse Unmarshall(UnmarshallerContext context) {
