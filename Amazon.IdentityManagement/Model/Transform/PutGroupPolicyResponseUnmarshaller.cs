...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class PutGroupPolicyResponseUnmarshaller : IResponseUnmarshaller<PutGroupPolicyResponse, UnmarshallerContext> {

        public PutGroupPolicyResponse Unmarshall(UnmarshallerContext context) {
        ...
        private static PutGroupPolicyResponseUnmarshaller instance;

        public static PutGroupPolicyResponseUnmarshaller GetInstance()
        {
            if (instance == null) 
            {
               instance = new PutGroupPolicyResponseUnmarshaller();
            }
            return instance;
        }
    }
