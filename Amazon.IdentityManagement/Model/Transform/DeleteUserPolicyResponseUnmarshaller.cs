...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class DeleteUserPolicyResponseUnmarshaller : IResponseUnmarshaller<DeleteUserPolicyResponse, UnmarshallerContext> {

        public DeleteUserPolicyResponse Unmarshall(UnmarshallerContext context) {
