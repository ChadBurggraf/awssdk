...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class UpdateLoginProfileResponseUnmarshaller : IResponseUnmarshaller<UpdateLoginProfileResponse, UnmarshallerContext> {

        public UpdateLoginProfileResponse Unmarshall(UnmarshallerContext context) {
