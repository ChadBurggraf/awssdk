...
namespace Amazon.IdentityManagement.Model.Transform
{
     ...
     /// </summary>
    internal class CreateGroupResultUnmarshaller : IUnmarshaller<CreateGroupResult, UnmarshallerContext> 
    {
        public CreateGroupResult Unmarshall(UnmarshallerContext context) 
        {
