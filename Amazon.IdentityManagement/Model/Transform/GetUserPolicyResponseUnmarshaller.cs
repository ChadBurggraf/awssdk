...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class GetUserPolicyResponseUnmarshaller : IResponseUnmarshaller<GetUserPolicyResponse, UnmarshallerContext> {

        public GetUserPolicyResponse Unmarshall(UnmarshallerContext context) {
