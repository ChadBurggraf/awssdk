...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class ListGroupPoliciesResponseUnmarshaller : IResponseUnmarshaller<ListGroupPoliciesResponse, UnmarshallerContext> {

        public ListGroupPoliciesResponse Unmarshall(UnmarshallerContext context) {
