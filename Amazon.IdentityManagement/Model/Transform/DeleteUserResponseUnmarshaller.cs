...
namespace Amazon.IdentityManagement.Model.Transform
{
    ...
    /// </summary>
    internal class DeleteUserResponseUnmarshaller : IResponseUnmarshaller<DeleteUserResponse, UnmarshallerContext> {

        public DeleteUserResponse Unmarshall(UnmarshallerContext context) {
